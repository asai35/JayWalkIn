...
@interface UpdateProfileViewController : UIViewController <UIGestureRecognizerDelegate , UITextFieldDelegate , UIImagePickerControllerDelegate , UINavigationControllerDelegate , MKMapViewDelegate,NIDropDownDelegate, UIPickerViewDelegate, UIPickerViewDataSource>
{
...
//    IBOutlet UITextField *tfPromoCode;
    ...
    IBOutlet UITextField *tfWebLink;
    IBOutlet UITextField *tfFBLink;
...
//    IBOutlet    UILabel *lblCardExp;
    ...
    IBOutlet UITableView *viewBusinessHours;
    ...
    IBOutlet UIView *businessHourViewCell;
    IBOutlet UIView *contentProView;
    ...
    IBOutlet UIActivityIndicatorView *activity;
     ...
     IBOutlet UILabel *lblfblink;
     IBOutlet UILabel *lbllogo;
     IBOutlet UILabel *lbldp;
     IBOutlet UILabel *lbllogostar;
    
    IBOutlet UIView *viewHoursPicker;
    IBOutlet UIPickerView *pickerHours;
    IBOutlet UIButton *hourCancelBtn;
    IBOutlet UIButton *hourDoneBtn;
}
