...
//                catId = @"10";
//            }
            NSMutableDictionary *parameters =[[NSMutableDictionary alloc] initWithDictionary:@{ @"email_id": tfEmail.text,
                                          @"name":tfName.text,
            ...
            [[JWNetWorkManager sharedManager] POST:@"add_merchant.php" data:parameters completion:^(id data, NSError *error) {
                ...
                if (error) {
                    ...
                    {
                        NSString *mrId = [NSString stringWithFormat:@"%@",[data objectForKey:@"merchant_id"]];
                        ...
                        alert = [UIAlertController alertControllerWithTitle:@"Successfull" message:@"Registered successfully." preferredStyle:UIAlertControllerStyleAlert];
                    ...
                    {
                        [self showAlert:@"Alert" message:@"This email id is already registerd with us." cancel:@"OK" other:nil];
                    }
